use crate::{type_conversion, type_impl, u104, u112, u120, u24, u40, u48, u56, u72, u80, u88};
...
type_conversion!(u24::u24, u128, u96);
type_conversion!(u40::u40, u128, u96);
type_conversion!(u48::u48, u128, u96);
type_conversion!(u56::u56, u128, u96);
type_conversion!(u72::u72, u128, u96);
type_conversion!(u80::u80, u128, u96);
type_conversion!(u88::u88, u128, u96);
type_conversion!(u104::u104, u128, u96);
type_conversion!(u112::u112, u128, u96);
type_conversion!(u120::u120, u128, u96);
...
mod tests {
    ...
    #[test]
    fn it_works() {
        let mut my_vec: Vec<u96> = Vec::with_capacity(512);
        my_vec.push(u96::from(u96::MAX_VALUE-10));
        my_vec.push(u96::from(4u32));
        my_vec.push(u96::from(4u32));
        println!("{}", my_vec[0]);
        println!("{}", my_vec[1]);
